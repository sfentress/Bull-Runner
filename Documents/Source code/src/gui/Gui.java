...
public class Gui extends javax.swing.JFrame {
    ...
    private BullRunner aoc;
    private GraphicsDevice device = null;
    private TestingEngine engine;
    private String inputType;
    private int lowestNumber, highestNumber;
    private boolean anyKeyAhead;
    private Key keyAhead, leftKey, rightKey;
     ...
     */
    public Gui(BullRunner aoc, GraphicsDevice d) {
        this.aoc = aoc;
        device = d;
    ...
    public void makeVisible(){
        ...
        Cursor invisibleCursor = getToolkit().createCustomCursor(
                invisImage, new Point(0,0), "Invisible");
    ...
    public void setOptions(){
        ...
        anyKeyAhead = options.isAnyKeyAhead();
        if (anyKeyAhead)
            keyAhead = new Key(true);
        else keyAhead = options.getKeyAhead();
        leftKey = options.getLeftKey();
        rightKey = options.getRightKey();
    ...
    private void initComponents() {
        ...
        jPanel_Anything = new javax.swing.JPanel();
        label_Anything = new javax.swing.JLabel();
        ...
        jPanel_OneSentTwoPicts = new javax.swing.JPanel();
        label_OSTP_StimWord = new javax.swing.JTextArea();
        OSTP_PictOption1 = new javax.swing.JPanel();
        OSTP_PictOption2 = new javax.swing.JPanel();
        ...
        jPanel_Anything.setLayout(new java.awt.GridBagLayout());

        jPanel_Anything.setOpaque(false);
        label_Anything.setFont(new java.awt.Font("Lucida Grande", 0, 36));
        label_Anything.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        label_Anything.setText("jLabel2");
        label_Anything.setMaximumSize(new java.awt.Dimension(800, 43));
        label_Anything.setMinimumSize(new java.awt.Dimension(800, 43));
        label_Anything.setPreferredSize(new java.awt.Dimension(800, 43));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.SOUTH;
        gridBagConstraints.insets = new java.awt.Insets(400, 0, 0, 0);
        jPanel_Anything.add(label_Anything, gridBagConstraints);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        getContentPane().add(jPanel_Anything, gridBagConstraints);
        ...
        instructionsPane.setMinimumSize(new java.awt.Dimension(670, 560));
        instructionsPane.setOpaque(false);
        instructionsPane.setPreferredSize(new java.awt.Dimension(670, 560));
        Instructions.setEditable(false);
        Instructions.setContentType("text/html");
        Instructions.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        Instructions.setEnabled(false);
        Instructions.setFocusable(false);
        Instructions.setMinimumSize(new java.awt.Dimension(650, 500));
        Instructions.setOpaque(false);
        Instructions.setPreferredSize(new java.awt.Dimension(650, 500));
        ...
        sound_text2.setPreferredSize(new java.awt.Dimension(610, 100));
        ...
        jPanel_OneSentTwoPicts.setLayout(new java.awt.GridBagLayout());

        label_OSTP_StimWord.setColumns(20);
        label_OSTP_StimWord.setFont(new java.awt.Font("Lucida Sans Typewriter", 0, 26));
        label_OSTP_StimWord.setLineWrap(true);
        label_OSTP_StimWord.setRows(4);
        label_OSTP_StimWord.setWrapStyleWord(true);
        label_OSTP_StimWord.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        label_OSTP_StimWord.setEnabled(false);
        label_OSTP_StimWord.setFocusable(false);
        label_OSTP_StimWord.setMinimumSize(new java.awt.Dimension(600, 240));
        label_OSTP_StimWord.setPreferredSize(new java.awt.Dimension(600, 240));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.gridwidth = 3;
        gridBagConstraints.insets = new java.awt.Insets(20, 0, 0, 0);
        jPanel_OneSentTwoPicts.add(label_OSTP_StimWord, gridBagConstraints);

        OSTP_PictOption1.setLayout(new java.awt.GridBagLayout());

        OSTP_PictOption1.setBackground(new java.awt.Color(255, 255, 255));
        OSTP_PictOption1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        OSTP_PictOption1.setMinimumSize(new java.awt.Dimension(502, 502));
        OSTP_PictOption1.setOpaque(false);
        OSTP_PictOption1.setPreferredSize(new java.awt.Dimension(502, 502));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.SOUTH;
        gridBagConstraints.insets = new java.awt.Insets(10, 5, 0, 6);
        jPanel_OneSentTwoPicts.add(OSTP_PictOption1, gridBagConstraints);

        OSTP_PictOption2.setLayout(new java.awt.GridBagLayout());

        OSTP_PictOption2.setBackground(new java.awt.Color(255, 255, 255));
        OSTP_PictOption2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        OSTP_PictOption2.setMinimumSize(new java.awt.Dimension(502, 502));
        OSTP_PictOption2.setOpaque(false);
        OSTP_PictOption2.setPreferredSize(new java.awt.Dimension(502, 502));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.SOUTH;
        gridBagConstraints.insets = new java.awt.Insets(10, 6, 0, 5);
        jPanel_OneSentTwoPicts.add(OSTP_PictOption2, gridBagConstraints);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        getContentPane().add(jPanel_OneSentTwoPicts, gridBagConstraints);
    ...
    private void formKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_formKeyPressed
        ...
        int keyCode = evt.getKeyCode();             // keyboard code for the key that was pressed
        int keyLoc = evt.getKeyLocation();
        int mask = evt.getModifiersEx();
        endTime = System.currentTimeMillis();   // Current time
        
        Key keyPressed = new Key(keyCode, keyLoc);
        
        if (keyCode == KeyEvent.VK_Q && mask == 128)              //If ctr-Q, exit
            aoc.restart();
        ...
        if (testType.equalsIgnoreCase("PARAGRAPH_TWO_WORDS") && guiType.equalsIgnoreCase("GUI_TEXT")){
            if (keyPressed.equals(keyAhead)){
                totalTime = endTime - startTime;
                totalTimeString = totalTimeString +  Long.toString(totalTime);
                engine.userAction("-", totalTimeString);
                return;
            } else return;
        }
        
        if (testType.equalsIgnoreCase("PARAGRAPH_TWO_WORDS") && guiType.equalsIgnoreCase("GUI_1S_2W")){
            if (keyPressed.equals(leftKey) || keyPressed.equals(rightKey)){
                guiType = "GUI_TEXT";
                // updateGUI();
                // return;
            } else return;
        ...
        //     if (testType.equalsIgnoreCase("PARAGRAPH") && !label_Anything.isVisible() &&
        //             keyPressed.equals(keyAhead))
        //         engine.displayNext();
    /*    if (testType.equalsIgnoreCase("PARAGRAPH")){
            if (!jPanel_Anything.isVisible()){
                if (keyPressed.equals(keyAhead)){
                    totalTime = endTime - startTime;
                    totalTimeString = totalTimeString +  Long.toString(totalTime);
                    engine.userAction("-", totalTimeString);
   ...
   */     
        ...
        if (testType.equalsIgnoreCase("ONE_SENT_MW")){       // If this is a moving-wondows test
            //   if (key == KeyEvent.VK_DOWN){
            String nextView = windowText.previewNext();
            if (!nextView.equalsIgnoreCase("~nomore~")){
                if (keyPressed.equals(40,1)){
                    ...
                    totalTimeString = totalTimeString + Long.toString(windowTime) + ",";
                    label_OSTW_StimWord.setText(nextView);
                    if (windowText.previewNext().equalsIgnoreCase("~nomore~") && values.length > 1){
                        jPanel_Anything.setVisible(true);
                        label_Anything.setText(values[1]);
                        label_Anything.setVisible(true);
                    }
                    return;
                } else return;
            }
        ...
        if (inputType.equalsIgnoreCase("lr")){
            if (keyPressed.equals(leftKey)) {              //If user hits left or right, record time and pass response to TestingEngine
                totalTime = endTime - startTime;
                totalTimeString = totalTimeString +  Long.toString(totalTime);
                if (engine.isExample)
        ...
        } else if (inputType.equalsIgnoreCase("letters")){
            if (keyPressed.isLetter()) {
                totalTime = endTime - startTime;
                totalTimeString = totalTimeString +  Long.toString(totalTime);
                if (engine.isExample)
                    engine.checkExampleAnswer(0);
                else engine.userAction(keyPressed.getString(), totalTimeString);
            }
        } else if (inputType.equalsIgnoreCase("numbers")){
            if (keyPressed.isNumber() && keyPressed.getNumber() >= lowestNumber
                    && keyPressed.getNumber() <= highestNumber) {
                totalTime = endTime - startTime;
                totalTimeString = totalTimeString +  Long.toString(totalTime);
                if (engine.isExample)
                    engine.checkExampleAnswer(0);
    ...
    public void setInputType(String inputType, int lowestNumber, int highestNumber){
    ...
    protected void updateGUI(){
        ...
        else if (guiType.equalsIgnoreCase("GUI_1S_2P"))
            hideEverythingExcept(jPanel_OneSentTwoPicts);
    ...
    public void setValues(String[] values){
        ...
        clipPlayed = false;
        this.values = values;
        // jPanel_Anything.setVisible(false);
        
        if (testType.equalsIgnoreCase("Intro") ||
                testType.equalsIgnoreCase("Instructions") ||
                testType.equalsIgnoreCase("Endtext")) {
            values[0] = values[0].replaceAll("TITLESIZE", ""+htmlFontSize+1);
            values[0] = values[0].replaceAll("TEXTSIZE", ""+htmlFontSize);
            Instructions.setText("<font size=" + htmlFontSize + ">" + values[0] + "</font>");
            if (values.length > 1){
        ...
        if (testType.equalsIgnoreCase("Paragraph_two_words")){
            if (!hasSound){
                if ((values.length == 1))
                    Instructions.setText("<font size=" + htmlFontSize + ">" + values[0] + "</font>");
                else {
                ...
                if (values.length == 1){
                    ...
                    clipPlayer = new ClipPlayer(this, values[0]);
                    clipPlayer.start();
                } else {
                    guiType = "GUI_1S_2W";
                    updateGUI();
                    if (values[0].toLowerCase().endsWith(".wav")){
                        Instructions.setText("");
            ...
            if (!hasSound){
                ...
                if (values.length == 1){
                    ...
                    if (values[0].toLowerCase().endsWith(".wav")){
                        ...
                        label_OSTW_Option1.setText("");
                        label_OSTW_Option2.setText("");
                        label_OSTW_Option1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 0, true));
                        label_OSTW_Option2.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 0, true));
                        jPanel_Anything.setVisible(true);
                        label_Anything.setText("");
                        label_Anything.setVisible(true);
                        clipPlayer = new ClipPlayer(this, values, new JLabel[] {label_Anything});
                        clipPlayer.start();
                    } else {
                        label_OSTW_StimWord.setText(values[0]);
                        label_OSTW_Option1.setText("");
        ...
        if (testType.equalsIgnoreCase("ONE_WORD")){
            if (!hasSound){
                ...
                label_OWTW_Option1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 0, true));
                label_OWTW_Option2.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 0, true));
                if (values.length > 1){
                    jPanel_Anything.setVisible(true);
                    label_Anything.setText(values[1]);
                    label_Anything.setVisible(true);
        ...
        if (testType.equalsIgnoreCase("TWO_WORDS")){
            if (!hasSound){
                ...
                label_TWTW_Option1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 0, true));
                label_TWTW_Option2.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 0, true));
                if (values.length>2){
                    jPanel_Anything.setVisible(true);
                    label_Anything.setText(values[2]);
                    label_Anything.setVisible(true);
                }
            } else {
                ...
                label_Anything.setVisible(true);
                if (values.length > 2)
                    clipPlayer = new ClipPlayer(this, values, 2, new JLabel[] {label_Anything});
                else clipPlayer = new ClipPlayer(this, values, 2, new JLabel[] {});
                clipPlayer.start();
            }
        }
        ...
        if (testType.equalsIgnoreCase("ONE_SENT")){
            if (!hasSound){
                label_OSTW_StimWord.setVisible(true);
                label_OSTW_StimWord.setText(values[0]);
                label_OSTW_Option1.setText("");
                ...
                if (values.length>1){
                    ...
                    clipPlayer = new ClipPlayer(this, values, new JLabel[] {});
                clipPlayer.start();
            }
        }
        ...
        if (testType.equalsIgnoreCase("ONE_SENT_MW")){
            windowText = new WindowText(values[0]);
            label_OSTW_StimWord.setText(windowText.next());
            label_OSTW_Option1.setText("");
            label_OSTW_Option2.setText("");
        ...
        if (testType.equalsIgnoreCase("ONE_SENT_TWO_PICTS")){
            if (!hasSound){
                label_OSTP_StimWord.setText(values[0]);
                GuiHelper.addPictures(new String[] {values[1], values[2]}, new JPanel[] {OSTP_PictOption1, OSTP_PictOption2}, true);
            } else {
                label_OSTP_StimWord.setVisible(false);
                GuiHelper.clearImages(new JPanel[] {OSTP_PictOption1, OSTP_PictOption2});
                clipPlayer = new ClipPlayer(this, values, new JPanel[] {OSTP_PictOption1, OSTP_PictOption2}, true);
                clipPlayer.start();
            }
        }
    ...
    void showHeadphones(boolean show){
        if (show){
            if (!jPanel_Sound.isVisible()){
                Logger.log("GUI: showing headphones");
    ...
    private void setFontSize(int size){
        label_Anything.setFont(new java.awt.Font("Lucida Grande", 0, size));
        label_OWTW_StimWord.setFont(new java.awt.Font("Lucida Grande", 0, size));
        label_OWTW_Option1.setFont(new java.awt.Font("Lucida Grande", 0, size));
        label_OWTW_Option2.setFont(new java.awt.Font("Lucida Grande", 0, size));
        StimWord1.setFont(new java.awt.Font("Lucida Grande", 0, size));
        label_TWTW_Option1.setFont(new java.awt.Font("Lucida Grande", 0, size));
        label_TWTW_Option2.setFont(new java.awt.Font("Lucida Grande", 0, size));
        label_TWTW_StimWord1.setFont(new java.awt.Font("Lucida Grande", 0, size));
        label_OSTW_Option1.setFont(new java.awt.Font("Lucida Grande", 0, size));
        label_OSTW_Option2.setFont(new java.awt.Font("Lucida Grande", 0, size));
        label_OSTW_StimWord.setFont(new java.awt.Font("Lucida Sans Typewriter", 0, size-10));
        htmlFontSize = size / 6;
    }
    /**
    ...
    private javax.swing.JPanel OSTP_PictOption1;
    private javax.swing.JPanel OSTP_PictOption2;
    ...
    private javax.swing.JPanel jPanel_Anything;
    private javax.swing.JPanel jPanel_OneSentTwoPicts;
    ...
    private javax.swing.JLabel label_Anything;
    private javax.swing.JTextArea label_OSTP_StimWord;
...
class ClipPlayer extends Thread {
    ...
    synchronized public void run() {
        ...
        if (isTest){
            ...
            parent.freeze();
            for (int i=0; i<clipAddress.length; i++){
                Logger.log("GUI: playing sound file: " + clipAddress[i]);
